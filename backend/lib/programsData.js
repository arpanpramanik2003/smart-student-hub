...
export const UNIVERSITY_PROGRAMS = {
  ...
  [PROGRAM_CATEGORIES.AGRICULTURE]: [
    ...
    { degree: 'B.F.Sc', name: 'Bachelor of Fisheries Science', duration: '4 years', hasLateralEntry: false, specializations: [] },
    {
      ...
      duration: '2 years',
      hasLateralEntry: false,
      specializations: ['Agronomy', 'Soil Science', 'Horticulture', 'Plant Pathology', 'Agricultural Economics'],
    },
  ],
  ...
  [PROGRAM_CATEGORIES.MANAGEMENT]: [
    {
      ...
      duration: '3 years',
      hasLateralEntry: false,
      specializations: ['Digital Marketing', 'Logistics & Supply Chain', 'Finance', 'International Business', 'Human Resource Management'],
    },
    {
      degree: 'MBA',
  ...
  [PROGRAM_CATEGORIES.PHD]: [
    {
      ...
      duration: 'Variable',
      hasLateralEntry: false,
      specializations: ['Engineering', 'Science', 'Humanities', 'Pharmacy', 'Agriculture', 'Management', 'Computer Applications'],
    },
  ],
};
