...
const AllActivities = ({ user, token }) => {
  ...
  return (
    <div className="space-y-6">
      {/* Header with Stats */}
      <div className="bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-600 dark:from-purple-900 dark:via-indigo-900 dark:to-blue-900 rounded-xl shadow-lg p-6 transition-colors">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
          <div>
            <div className="flex items-center space-x-3 mb-2">
              <div className="w-10 h-10 bg-white/20 dark:bg-white/10 backdrop-blur-sm rounded-lg flex items-center justify-center transition-colors">
            ...
            <p className="text-purple-100 dark:text-purple-200 ml-13 transition-colors">
          ...
          <div className="flex space-x-6 text-sm">
            <div className="text-center bg-white/10 dark:bg-white/5 backdrop-blur-sm rounded-lg px-4 py-3 transition-colors">
              <div className="text-2xl font-bold text-white">
                {stats?.totalActivities || 0}
              </div>
              <div className="text-purple-100 dark:text-purple-200 transition-colors">Total</div>
            </div>
            <div className="text-center bg-white/10 dark:bg-white/5 backdrop-blur-sm rounded-lg px-4 py-3 transition-colors">
              <div className="text-2xl font-bold text-white">
                {stats?.pendingCount || 0}
              </div>
              <div className="text-purple-100 dark:text-purple-200 transition-colors">Pending</div>
            </div>
            <div className="text-center bg-white/10 dark:bg-white/5 backdrop-blur-sm rounded-lg px-4 py-3 transition-colors">
              <div className="text-2xl font-bold text-white">
                {stats?.approvedCount || 0}
              </div>
              <div className="text-purple-100 dark:text-purple-200 transition-colors">Approved</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
          ...
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg leading-5 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:placeholder-gray-400 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 sm:text-sm transition-all duration-200"
            />
          </div>
          ...
          <div className="flex space-x-4">
            <select
              ...
              className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 sm:text-sm transition-all duration-200 hover:border-purple-400"
            >
      ...
      {filteredActivities.length > 0 ? (
              ...
              <div className="p-6">
                <div className="flex items-start justify-between space-x-6">
                  <div className="flex-1 min-w-0">
                    ...
                    {/* Student Info */}
                    <div className="flex items-center space-x-4 mb-3 text-sm text-gray-600 dark:text-gray-400 transition-colors">
                          <div className="flex items-center">
                            ...
                            <span className="text-gray-400 dark:text-gray-500 ml-2 transition-colors">({activity.student?.studentId})</span>
                          </div>
                          <div className="flex items-center">
                            <svg className="w-4 h-4 mr-2 text-gray-400 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {/* Activity Details */}
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600 dark:text-gray-400 mb-4 transition-colors">
                          <div className="flex items-center">
                            <svg className="w-4 h-4 mr-2 text-gray-400 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {(activity.organizer || activity.description) && (
                      <div className="space-y-2 mb-4">
                            ...
                            {activity.description && (
                              <p className="text-sm text-gray-700 dark:text-gray-300 line-clamp-2 transition-colors">{activity.description}</p>
                        )}
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex flex-col items-end space-y-3 text-sm">
                        <div className="text-right">
                          <p className="text-gray-500 dark:text-gray-400 transition-colors">Submitted</p>
                          <p className="font-medium text-gray-900 dark:text-gray-100 transition-colors">{new Date(activity.createdAt).toLocaleDateString()}</p>
                        </div>
                        
                        {activity.approver && (
                          <div className="text-right">
                            <p className="text-gray-500 dark:text-gray-400 transition-colors">Reviewed by</p>
                            <p className="font-medium text-gray-900 dark:text-gray-100 transition-colors">{activity.approver.name}</p>
                          </div>
                        )}

                    {activity.remarks && (
                      <div className="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-700 rounded-md p-2 max-w-48 transition-all duration-200 hover:scale-105">
                        <p className="text-xs font-semibold text-yellow-800 dark:text-yellow-300 mb-1 transition-colors">Faculty Remarks</p>
                        <p className="text-xs text-yellow-700 dark:text-yellow-400 transition-colors">{activity.remarks}</p>
                      </div>
                    )}
                    ...
                    {activity.filePath && (
                      <button
                        ...
                        className="inline-flex items-center px-3 py-1 rounded-md text-xs font-medium bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-300 hover:bg-blue-200 dark:hover:bg-blue-900/70 transition-all duration-200 hover:scale-105 active:scale-95"
                      >
                ...
                {activity.filePath && visibleFiles[activity.id] && (
                  <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-md transition-all duration-300">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <svg className="w-5 h-5 text-blue-600 dark:text-blue-400 mr-2 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                        <span className="text-sm font-medium text-blue-800 dark:text-blue-300 transition-colors">Certificate Document</span>
                      </div>
                      {(() => {
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 transition-colors">
          <div className="text-center py-12">
            <div className="w-24 h-24 mx-auto mb-4 bg-gradient-to-br from-purple-100 to-blue-100 dark:from-purple-900/30 dark:to-blue-900/30 rounded-full flex items-center justify-center transition-colors">
