                      ...
                      <div>
                        ...
                        {visibleFiles[activity.id] && (
                          <div className="mt-2 flex space-x-2">
                            <a
                              href={`${import.meta.env.VITE_API_URL}/files/view?url=${encodeURIComponent(activity.filePath.startsWith('http') ? activity.filePath : `${import.meta.env.VITE_API_URL?.replace('/api', '') || 'http://localhost:5000'}${activity.filePath}`)}`}
                              target="_blank"
