                        ...
                        {visibleFiles[activity.id] && (
                          <div className="mt-2 flex flex-col gap-2">
                            <div className="flex space-x-2">
                              <a
                                href={`https://docs.google.com/gview?url=${encodeURIComponent(activity.filePath.startsWith('http') ? activity.filePath : `${import.meta.env.VITE_API_URL?.replace('/api', '') || 'http://localhost:5000'}${activity.filePath}`)}&embedded=true`}
                                target="_blank"
